...
<div class="container" style="background-color:white;  color: black;">
    ...
    <h2 class="py-3" style="text-align:center">Custom Genareted Report-products</h2>
    <div class="row"><div class="col-3"><h6>Invoice Id:</h6></div><div class="col-3"><h6 id="id"></h6></div></div>
    <div class="row"><div class="col-3"><h6>Type:</h6></div><div class="col-3"><h6></h6>Sell Product</div></div>
...
//set date
        ...
        $.get("../../routes/invoice/cusmonthly.php",{start:start_date,end:end_date}, function (res) {
                //display data 
                $("#mesh_list").html(res);
        })
}
